...
s1, Verify create inventory subscription with junk data gets 400 error. 
    ...
    ${subscriptionRequest}   Set Variable   {"consumerSubscriptionId" "69253c4b-8398-4602-855d-783865f5f25c","filter" "(eq,extensions/country,US);","callback" "https://10.6.85.1:1080/smo/v1/"}
...
s2, Verify create inventory subscription with unsupported data gets 400 error.
    ...
    ${subscriptionRequest}      Set Variable   <?xml version="1.0" encoding="UTF-8" ?><root><consumerSubscriptionId>69253c4b-8398-4602-855d-783865f5f25c</consumerSubscriptionId><filter>(eq,extensions/country,US);</filter><callback>https://10.6.85.1:1080/smo/v1/o2ims_inventory_observer</callback></root>
    ${res}=   POST On Session   o2ims   /o2ims-infrastructureInventory/v1/subscriptions   data=${subscriptionRequest}   expected_status=400
    log      ${res}   level=DEBUG
    Status Should Be   400   ${res}
...
s3, Verify create monitoring alarm subscription with junk data gets 400 error.
    ...
    ${subscriptionAlarmRequest}      Set Variable   {"consumerSubscriptionId" "16d5fc54-cee0-4532-9826-2369f8240e1b","filter" "NEW","callback" "https://10.6.85.1:1080/smo/v1/o2ims_inventory_observer"}
    ${res}=   POST On Session   o2ims   /o2ims-infrastructureInventory/v1/subscriptions   data=${subscriptionAlarmRequest}   expected_status=400
    log      ${res}   level=DEBUG
    Status Should Be   400   ${res}
...
s4, Verify create monitoring alarm subscription with unsupported data gets 400 error.
    ...
    ${subscriptionAlarmRequest}      Set Variable   <?xml version="1.0" encoding="UTF-8" ?><root><consumerSubscriptionId>16d5fc54-cee0-4532-9826-2369f8240e1b</consumerSubscriptionId><filter>NEW<filter><callback>https://10.6.85.1:1080/smo/v1/o2ims_inventory_observer</callback></root>
    ${res}=   POST On Session   o2ims   /o2ims-infrastructureInventory/v1/subscriptions   data=${subscriptionAlarmRequest}   expected_status=400
    log      ${res}   level=DEBUG
    Status Should Be   400   ${res}