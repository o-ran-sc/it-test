...
s6, Verify operate Inventory Subscription with unsupported method gets 405 error.
    ...
    ${subscriptionRequest}   input   {"filter":"(eq,extensions/country,ES);","callback":"${SMO_INV_OBSERVER_URL}","consumerSubscriptionId":"69253c4b-8398-4602-855d-783865f5f25c","subscriptionId":"167351c9-74e8-440c-aeed-80ca2a5707aa"}
    Clear Expectations
    # Expect Response Body        ${CURDIR}/schemas/unsupported_method_properties.json
...
s8, Verify operate Alarm Subscription with unsupported method gets 405 error.
    ...
    ${subscriptionAlarmRequest}    input    {"consumerSubscriptionId": "16d5fc54-cee0-4532-9826-2369f8240e1b","filter": "NEW","callback": "${SMO_INV_OBSERVER_URL}"}
    Clear Expectations
    # Expect Response Body        ${CURDIR}/schemas/unsupported_method_properties.json
